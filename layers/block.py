...
class Block(nn.Module):
    def __init__(
        ...
        if ffn_adapt:
            self.adaptmlp = Adapter(self.config, dropout=0.1, bottleneck=ffn_num,
                                    init_option=ffn_adapter_init_option,
                                    adapter_scalar=ffn_adapter_scalar,
                                    adapter_layernorm_option=ffn_adapter_layernorm_option,
                                    d_model=768
                                    )
