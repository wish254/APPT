...
# from data_utils.utils.build import DATASETS, build_dataloader_from_cfg
# from data_utils.utils.config import EasyConfig
...
class ShapeNetPartNormal(Dataset):
    ...
    def __init__(self,
                 data_root='/root/wish/Point-NN-main/data/shapenetcore_partanno_segmentation_benchmark_v0_normal',
                 num_points=2048,
                 split='train',
                 class_choice=None,
                 use_normal=True,
